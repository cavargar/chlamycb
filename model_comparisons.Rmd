...
pf_d<-function(ss,sig,zf){
  p<-mapply(p_fp,expmoddf$vol,expmoddf$ndiv,ss,sig,zf[1],zf[2],zf[3],zf[4],zf[5],zf[6],zf[7],zf[8])
  return(p)
}
```
...
expmoddf$p_plwo<-pf_pl(170,0.01)
expmoddf$p_pl<-pf_pl(170,0.5)
expmoddf$p_d<-pf_d(198.3107,0.3099628,c(0.2488859,0.5247278,1.674277,2.543094,3.516225,5.625057))
#expmoddf$p_3p<-pf_3p(147,0.3,0.7)
...
gpdata<-ggplot(exp_data,aes(x=vol,y=as.factor(ndiv),color=as.factor(ndiv)))+
  ...
  theme_classic()
gpdata
ggsave("wt_div_mth.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}
gpexpmod0<-ggplot(expmoddf%>%filter(src=="p_3p"))+
  geom_line(aes(x=vol,y=p,color=as.factor(ndiv)),size=2,alpha=0.5)+
  geom_point(data=expmoddf%>%filter(src=="exp"),aes(x=vol,y=p,color=as.factor(ndiv)))+
  scale_x_log10(limits=c(10,10000))+
  ylim(0,1)+
  theme_classic()
gpexpmod0
ggsave("wt_prob_mth.png",width = 15,height = 3)
```
...
```
```{r fig.height=3, fig.width=15}
expmoddf[expmoddf$src=="p_plwo","vol"]<-log2(expmoddf[expmoddf$src=="p_plwo","vol"]/170)
expmoddf[expmoddf$src=="p_pl","vol"]<-log2(expmoddf[expmoddf$src=="p_pl","vol"]/170)
expmoddf[expmoddf$src=="p_d","vol"]<-log2(expmoddf[expmoddf$src=="p_d","vol"]/198.3107)
gpexpmod0<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==0))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  ylim(0,1)+
  scale_x_continuous(breaks = -1:5,limits = c(-1,5))+
  scale_colour_manual(breaks = c("p_plwo","p_pl","p_d"),values = c("orange","#619CFF","#F8766D"))+
  theme_classic()
gpexpmod0
ggsave("lg2_comp_div0.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}

gpexpmod0<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==1))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  scale_x_continuous(breaks = -1:5,limits = c(-1,5))+
  scale_colour_manual(breaks = c("p_plwo","p_pl","p_d"),values = c("orange","#619CFF","#F8766D"))+
  ylim(0,1)+
  theme_classic()
gpexpmod0
ggsave("lg2_comp_div1.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}

gpexpmod0<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==2))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  scale_x_continuous(breaks = -1:5,limits = c(-1,5))+
  scale_colour_manual(breaks = c("p_plwo","p_pl","p_d"),values = c("orange","#619CFF","#F8766D"))+
  ylim(0,1)+
  theme_classic()
gpexpmod0
ggsave("lg2_comp_div2.png",width = 15,height = 3)
```

```{r fig.height=3, fig.width=15}

gpexpmod0<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==3))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  scale_x_continuous(breaks = -1:5,limits = c(-1,5))+
  scale_colour_manual(breaks = c("p_plwo","p_pl","p_d"),values = c("orange","#619CFF","#F8766D"))+
  ylim(0,1)+
  theme_classic()
gpexpmod0
ggsave("lg2_comp_div3.png",width = 15,height = 3)
```

```{r fig.height=3, fig.width=15}

gpexpmod0<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==4))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  scale_x_continuous(breaks = -1:5,limits = c(-1,5))+
  scale_colour_manual(breaks = c("p_plwo","p_pl","p_d"),values = c("orange","#619CFF","#F8766D"))+
  ylim(0,1)+
  theme_classic()
gpexpmod0
ggsave("lg2_comp_div4.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}

gpexpmod0<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==5))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  scale_x_continuous(breaks = -1:5,limits = c(-1,5))+
  scale_colour_manual(breaks = c("p_plwo","p_pl","p_d"),values = c("orange","#619CFF","#F8766D"))+
  ylim(0,1)+
  theme_classic()
gpexpmod0
ggsave("lg2_comp_div5.png",width = 15,height = 3)
```
...
gpexpmod1<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==1))+
  ...
  theme_classic()
gpexpmod1
ggsave("wt_prob_mth_div1.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}
gpexpmod2<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==2))+
  ...
  theme_classic()
gpexpmod2
ggsave("wt_prob_mth_div2.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}
gpexpmod3<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==3))+
  ...
  theme_classic()
gpexpmod3
ggsave("wt_prob_mth_div3.png",width = 15,height = 3)
```
...
gpexpmod4<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==4))+
  ...
  theme_classic()
gpexpmod4
ggsave("wt_prob_mth_div4.png",width = 15,height = 3)
```
```{r fig.height=3, fig.width=15}
gpexpmod5<-ggplot(expmoddf%>%filter(!src=="exp",ndiv==5))+
  geom_line(aes(x=vol,y=p,color=src,linetype=src),size=2)+
  geom_point(data=expmoddf%>%filter(src=="exp",ndiv==5),aes(x=vol,y=p))+
  scale_x_log10(limits=c(10,10000))+
  ylim(0,1)+
  theme_classic()
gpexpmod5
ggsave("wt_prob_mth_div5.png",width = 15,height = 3)
```
```{r}
ggplot(expmoddf%>%filter(src=="exp",ndiv==0),aes(x=vol,y=log(p)))+
  geom_point()+
  geom_smooth(method='lm', formula= y~x)+
  geom_smooth(method='lm', formula= y~I(-x^2), color = "red")+
  geom_smooth(method='lm', formula= y~I(-x^4), color = "black")
```
```{r}
ggplot(expmoddf%>%filter(src=="exp",ndiv==0),aes(x=vol,y=log(p)))+
  geom_point()+
